...
output_dir <- here::here("output") # change this when running on real data

summary_stats <- jsonlite::fromJSON(txt=here::here("output", "data_summary", "summary_stats.json"))
...
print_variable_surv <- function(variable){
...
As of `r summary_stats$end_date`, there were `r summary_stats$total_vaccinated` TPP-registered patients who had received at least one vaccine dose. Of these, `r summary_stats$total_vaccinated_pfizer` received the Pfizer vaccine and `r summary_stats$total_vaccinated_oxford` received the Oxford/AZ vaccine.
...
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_surv("sex")
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_haz("sex")
...
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_surv("ageband")
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_haz("ageband")
...
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_surv("ethnicity")
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_haz("ethnicity")
...
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_surv("imd")
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_haz("imd")
...
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_surv("region")
cat("&nbsp;  \n")
cat("&nbsp;  \n")
print_variable_haz("region")
