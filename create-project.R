...
actions_list <- splice(
  ...
  action(
    ...
    moderately_sensitive = list(
      svg = glue("output/over80s/all/0/combined/VEstcox*.svg"),
      png = glue("output/over80s/all/0/combined/VEstcox*.png"),
      csv = glue("output/over80s/all/0/combined/stcox*.csv")
    )
  ),
