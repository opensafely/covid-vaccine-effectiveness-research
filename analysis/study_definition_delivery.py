...
study = StudyDefinition(
    ...
    registered=patients.registered_as_of(
        "2020-12-07",  # day before vaccination campaign starts - discuss with team if this should be "today"
    ...
    sex=patients.sex(
        return_expectations={
            "rate": "universal",
            "category": {"ratios": {"M": 0.49, "F": 0.50, "I":0.005, "U":0.005}},
        }
    ),
    ...
    dmards=patients.with_these_medications(
        dmards_codes, returning="binary_flag", return_expectations={"incidence": 0.01,},
    ),
    ...
    postvac_primary_care_covid_case=patients.with_these_clinical_events(
        combine_codelists(
            covid_primary_care_code,
            covid_primary_care_positive_test,
            covid_primary_care_sequalae,
        ...
        return_expectations={
            "date": {"earliest": "2021-03-01", "latest" : "2021-03-30"},
            "rate": "uniform",
            "incidence": 0.01,
        },
    ),
    ...
    # +ve test date
    postvac_positive_test_date_SGSS=patients.with_test_result_in_sgss(
        pathogen="SARS-CoV-2",
        test_result="positive",
        on_or_after="covid_vacc_date",
        find_first_match_in_period=True,
        ...
        date_format="YYYY-MM-DD",
        return_expectations={
            "date": {"earliest": "2021-04-01", "latest" : "2021-04-30"},
            "rate": "uniform",
            "incidence": 0.01,
        },
    ),

    # covid admission date
    postvac_admitted_date=patients.admitted_to_hospital(
