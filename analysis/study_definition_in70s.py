...
# start_date is currently set to when more than just a (highly selected) handful of over 70s we being vaccinated
...
study = StudyDefinition(
    ...
    admitted_unplanned_6_date=patients.admitted_to_hospital(
        returning="date_admitted",
        on_or_after="admitted_unplanned_5_date + 1 day",
        with_admission_method=["21", "22", "23", "24", "25", "2A", "2B", "2C", "2D", "28"],
        with_patient_classification = ["1"],
        date_format="YYYY-MM-DD",
        find_first_match_in_period=True,
    ...
    discharged_unplanned_6_date=patients.admitted_to_hospital(
        returning="date_discharged",
        on_or_after="admitted_unplanned_5_date + 1 day",
        with_admission_method=["21", "22", "23", "24", "25", "2A", "2B", "2C", "2D", "28"],
        with_patient_classification = ["1"],
    ...
    # ),
    # 
    # admitted_unplanned_infectious_6_date=patients.admitted_to_hospital(
    #     returning="date_admitted",
    #     on_or_after="admitted_unplanned_infectious_5_date + 1 day",
    #     with_admission_method=["21", "22", "23", "24", "25", "2A", "2B", "2C", "2D", "28"],
    #     with_patient_classification = ["1"],
    #     with_these_diagnoses = ICD10_I_codes,
    #     date_format="YYYY-MM-DD",
    ...
    # ),
    # 
    # discharged_unplanned_infectious_6_date=patients.admitted_to_hospital(
    #     returning="date_discharged",
    #     on_or_after="admitted_unplanned_infectious_5_date + 1 day",
    #     with_admission_method=["21", "22", "23", "24", "25", "2A", "2B", "2C", "2D", "28"],
    #     with_patient_classification = ["1"],
...
#######################################################
    ...
    admitted_planned_6_date=patients.admitted_to_hospital(
        returning="date_admitted",
        on_or_after="admitted_planned_5_date + 1 day",
        with_admission_method=["11", "12", "13", "81"],
        date_format="YYYY-MM-DD",
        find_first_match_in_period=True,
        return_expectations={
    ...
    discharged_planned_6_date=patients.admitted_to_hospital(
        returning="date_discharged",
        on_or_after="admitted_planned_5_date + 1 day",
        with_admission_method=["11", "12", "13", "81"],
        date_format="YYYY-MM-DD",
