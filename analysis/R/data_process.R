...
# imports data extracted by the cohort extractor OR generated by the `data_makedummy.R` script (depending on if it's being run in the server or not)
...
# saves one-row-per-patient dataset for vaccines
