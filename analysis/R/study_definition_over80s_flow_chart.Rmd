...
#### Non care home (tpp flag only)
```{r, echo = FALSE}
criteria_3tpp <- data_flow_chart %>%
  filter(age >= 80,
         registered_at_latest == TRUE,
         has_died == FALSE,
         has_follow_up_previous_year == TRUE,
...
Excluded = `r nrow(criteria_2) - nrow(criteria_3tpp)`
...
#### Non care home (+ code only)
```{r, echo = FALSE}
criteria_3code <- data_flow_chart %>%
  filter(age >= 80,
         registered_at_latest == TRUE,
         has_died == FALSE,
         has_follow_up_previous_year == TRUE,
         care_home_tpp == FALSE,
         care_home_code == FALSE) 
```

Excluded = `r nrow(criteria_3tpp) - nrow(criteria_3code)`
...
criteria_3 <- data_flow_chart %>%
  filter(age >= 80,
         ...
         care_home_tpp == FALSE,
         care_home_code == FALSE,
         care_home_household == FALSE) 
```

Excluded = `r nrow(criteria_3code) - nrow(criteria_3)`
