...
data_cohorts <- data_all %>%
  transmute(
    patient_id,
    over80s = (age>=80) & (!care_home_combined) & (is.na(prior_positive_test_date) & is.na(prior_primary_care_covid_case_date) & is.na(prior_covidadmitted_date)),
    in70s = (age>=70 & age<80) & (!care_home_combined) & (is.na(prior_positive_test_date) & is.na(prior_primary_care_covid_case_date) & is.na(prior_covidadmitted_date)) ,
