...
knit: (function(inputFile, encoding) { rmarkdown::render(inputFile, encoding = encoding, output_dir = here::here("output")) })
output: 
  html_document
---
...
#### Patients with with non-missing IMD
```{r, echo = FALSE}
...
#### Patients with with non-missing region
```{r, echo = FALSE}
...
#### Patients with with non-missing ethnicity
```{r, echo = FALSE}
...
## Patients with well defined sex and non-missing IMD, region and ethnicity 
exclude3 <- boxGrob(glue("Missing data (n = {tot})",
                         " - Sex: {sex}",
                         " - Ethnicity: {eth}",
                         " - IMD: {imd}",
                         " - Region: {region}",
                         tot = txtInt(nrow(criteria_3) - nrow(criteria_7)),
