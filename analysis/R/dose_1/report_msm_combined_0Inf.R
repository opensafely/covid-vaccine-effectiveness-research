...
write_csv(estimates, path = here("output", "combined", glue("estimates_timesincevax.csv")))
write_csv(estimates_formatted, path = here("output", "combined", glue("estimates_formatted_timesincevax.csv")))
write_csv(estimates_formatted_wide, path = here("output", "combined", glue("estimates_formatted_wide_timesincevax.csv")))
